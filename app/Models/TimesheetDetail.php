...
class TimesheetDetail extends Model
{
    ...
    {
        $approval_ts = DB::select(DB::raw('select DATE_FORMAT(approval_histories.moderated_at, \'%d-%m-%Y %H:%i:%p\') as date,sequence_id,
CASE 
...
, 
        ...
        END status
from approval_histories where transaction_type = 2 
